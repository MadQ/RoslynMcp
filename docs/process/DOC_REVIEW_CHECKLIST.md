...
# 3. Verify tool count is consistent (should be 33 tools currently, 31 public + 2 debug-only)
...
- [ ] Architecture tables list all 33 tools consistently
...
### AGENTS.md
- [ ] Architecture table has all 33 tools
