...
- **`Copilot CLI` agent detection** — `CopilotCliClient` added to `AgentDetector.AllClients`; configures `.mcp.json` in the current working directory under the `servers` key (closes #186)
