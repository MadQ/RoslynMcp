...
internal sealed class FindUnusedTool : RoslynMcpTool
{
	...
	[Description(
		"Finds private and internal source symbols with zero direct static references across the loaded solution. " +
		"Checks types, methods, constructors, fields, properties, and events. " +
		"Conservatively skips compiler-generated symbols, attributed symbols, interface implementations, and inheritance-dispatched members. " +
		"Results are paged and include declaration locations. Dynamic or reflection-based usage cannot be detected.")]
	...
	{
		if(symbol.DeclaredAccessibility is not Accessibility.Private and not Accessibility.Internal)
