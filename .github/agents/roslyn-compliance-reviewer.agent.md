...
- Verify compliance with the repo's net8.0/net10.0 targets and preview C# language standards
...
7. Ensure modern preview C# features and the repo's .NET targets are properly utilized where applicable
...
- **C# Features**: Identify opportunities to leverage the current preview language version (currently C# 14); flag any incompatible patterns
...
- **Modernization Opportunities**: preview C# features or repo-target-specific .NET improvements that could improve the code
...
- Double-check that recommendations are accurate for the repo's net8.0/net10.0 targets and current preview C# version
