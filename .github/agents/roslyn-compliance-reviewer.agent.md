...
- Verify compliance with .NET 10 and C# 13 standards
...
7. Ensure modern C# 13 and .NET 10 features are properly utilized where applicable
...
- **C# 13 Features**: Identify opportunities to leverage new language features; flag any incompatible patterns
...
- **Modernization Opportunities**: C# 13 or .NET 10 features that could improve the code
...
- Double-check that recommendations are accurate for .NET 10 and C# 13 specifically
