...
- Verify compliance with the repo's net10.0 target and preview C# language standards
...
- Double-check that recommendations are accurate for the repo's net10.0 target and current preview C# version
